<div class="footer flex">
    ...
    <div class="flex footer_content">
        ...
        <nav class="flex footer_content_socials">
            ...
            <a class="link eaves" href="{{$facebook_link}}" title="{{__('texts.go_to_facebook')}}">
        ...
        <div class="flex footer_content_contact_info">
            ...
            <a class="link eaves" href="{{$address_link}}" title="{{__('texts.see_address_on_google_map')}}">{{$address}}</a>
    ...
    <div class="footer_legal_mentions flex">
        ...
        <div class="flex footer_legal_mentions_content">
            ...
            <p class="eaves">{{__('texts.created_by')}} <a class="eaves link" href="{{$marvin_portfolio_link}}" title="{{__('texts.go_to_marvin_portfolio')}}">Marvin Pagnoul</a></p>
